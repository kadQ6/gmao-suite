  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="text-xs text-slate-500">
        ...
        <Link href={`/portal/psa-rwanda/sites/${siteId}`} className="hover:text-kbio-navy">{eq.site.nom}</Link>
        <span className="mx-2">/</span>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            ...
            <h2 className="text-xl font-bold text-kbio-navy">{eq.designation}</h2>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
          <h3 className="text-base font-semibold text-kbio-navy">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-1 min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {m.numeroPV && (
                        <span className="text-xs font-mono text-kbio-teal">{m.numeroPV}</span>
                      )}
                      {m.technicien && (
                      ...
                      {m.coutTotal && (
                        <span className="text-xs font-semibold text-kbio-navy">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
          ...
          {totalCostPieces > 0 && (
            <span className="text-sm font-bold text-kbio-navy">
