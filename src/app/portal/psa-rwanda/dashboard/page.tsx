...
export default async function PsaDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-bold text-kbio-navy">Dashboard — Bilan consolidé PSA Rwanda</h2>
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm text-center">
              <p className="text-3xl font-bold text-kbio-navy">{sites.length}</p>
              <p className="text-xs text-slate-500 mt-1">Sites</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm text-center">
              <p className="text-3xl font-bold text-kbio-navy">{totalEquip}</p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-slate-100">
              <h3 className="text-base font-semibold text-kbio-navy">Comparaison par site</h3>
            </div>
              ...
              <table className="min-w-full text-sm">
                    ...
                    return (
                      <tr key={site.id} className="hover:bg-slate-50 transition-colors">
                        <td className="px-4 py-3">
                          <Link href={`/portal/psa-rwanda/sites/${site.id}`} className="font-medium text-kbio-teal hover:text-kbio-navy">
                            {site.nom}
                          </Link>
                          <p className="text-xs text-slate-400 font-mono">{site.code}</p>
                        </td>
                        <td className="px-4 py-3 text-xs text-kbio-teal font-medium">{site.capaciteO2 || "—"}</td>
                        ...
                        <td className="px-4 py-3 text-right font-semibold text-kbio-navy tabular-nums">
                          {sCost > 0 ? fmt(sCost) : "—"}
                        </td>
                ...
                <tfoot className="bg-slate-50 border-t-2 border-slate-200 text-xs font-bold uppercase text-slate-600">
                  <tr>
                    ...
                    <td className="px-4 py-3 text-right text-kbio-navy text-sm">{fmt(totalPiecesCost)}</td>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="px-5 py-4 border-b border-slate-100">
                <h3 className="text-base font-semibold text-kbio-navy">Résumé maintenances</h3>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="px-5 py-4 border-b border-slate-100">
                <h3 className="text-base font-semibold text-kbio-navy">Résumé pièces détachées</h3>
              </div>
              <div className="p-5 space-y-4">
